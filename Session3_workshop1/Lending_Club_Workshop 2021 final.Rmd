...
- Yes. From the results of linear regressions, we find almost all the time related variables significant. Therefore, the interest rates do change over time. The predictions can be improved by adding quarter-year dummies. The RMSE has been improved from 0.0103 to 0.0076.
...
plsFit<-train(
    int_rate ~  loan_amnt*grade + term +dti + quartiles_annual_inc  + Price * grade, #fill your variables here 
    lc_with_bonds,
    method = "lm",
    trControl = control
   )
...
plsFit<-train(
    int_rate ~  loan_amnt*grade + term +dti + quartiles_annual_inc + Price*grade+ CPALTT01USQ657N * grade, #fill your variables here 
    lc_bonds_cpi,
    method = "lm",
    trControl = control
   )
