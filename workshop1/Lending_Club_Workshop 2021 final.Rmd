...
time2<-train(
    int_rate ~ loan_amnt*grade + term +dti + quartiles_annual_inc + issue_d + issue_d * grade, #fill your variables here 
    lc_clean,
   method = "lm",
    trControl = control
   )
...
time4<-train(
    int_rate ~ loan_amnt*grade + term +dti + quartiles_annual_inc + yq + yq * grade, #fill your variables here 
    lc_clean_quarter,
     method = "lm",
    trControl = control
   )
